###################################
#                                 #
# Bisnode firm dataset            #
#   use of ML on binary outcome   #
#                                 #
###################################
...
# Alternatively: you can call it from your wp
...
#
# Reading as rds
data <- read_rds('https://github.com/regulyagoston/BA21_Coding/raw/main/Class_4/data/bisnode_firms_clean.rds')
...
ggplot( data = data , aes( x = default ) ) +
